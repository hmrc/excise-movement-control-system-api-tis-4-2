...
From 1 October 2026, EMCS will support the movement of vaping products under Vaping Products Duty (VPD).

If your software supports EMCS movements for vaping products, you must update it before this date to ensure it complies with the new requirements.

For more information, see [Vaping Products Duty (VPD)](documentation/vaping-products-duty.html).
...
[Design Document for National Excise Applications (DDNEA) v3.23 for phase 4.2](<https://github.com/hmrc/excise-movement-control-system-api-tis-4-2/blob/main/source/downloads/eu-docs/Design Document for National Excise Applications (DDNEA) v3.23 for phase 4.2.zip>)

ZIP, 7 MB

[Functional Excise System Specifications (FESS) v4.22 for phase 4.2](<https://github.com/hmrc/excise-movement-control-system-api-tis-4-2/blob/main/source/downloads/eu-docs/Functional Excise System Specifications (FESS) v4.22 for phase 4.2.zip>)

ZIP, 18 MB

[Release Scope Document (RSD) v2.00 for phase 4.2](<https://github.com/hmrc/excise-movement-control-system-api-tis-4-2/blob/main/source/downloads/eu-docs/Release Scope Document (RSD) v2.00 for phase 4.2.zip>)
